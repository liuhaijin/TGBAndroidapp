...
//                Log.d("test", "onScrolled");
                ...
                if (lastVisibleItemPosition + 1 == adapter.getItemCount() && adapter.getFooterType() == RecyclerViewAdapter.FOOTER_LOAD_MORE) {
                    ...
                    if (!isLoading) {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                if(data.size() > 15){
                                    isLoading = false;
                                    adapter.setFooterType(RecyclerViewAdapter.FOOTER_NO_ITEM);
...
//        Log.i("androidId", androidId);
    ...
    private void getData(int start_id) {
        ...
        call.enqueue(new retrofit2.Callback<List<Notice>>() {
            @Override
            public void onResponse(Call<List<Notice>> call, Response<List<Notice>> response) {
                if(response.body() == null){
                    ...
                    adapter.setFooterType(RecyclerViewAdapter.FOOTER_LOAD_MORE);
